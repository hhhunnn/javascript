...
/*
    ...
    - 단순 .sort()로 정렬하면 사전식 정렬을 하게 됨 (문자열처럼)
*/
// array.sort();
// console.log(array);
// 오름차순일때는 x - y , 내림차순일 때는 y - x
// 오름차순
...
/*
    findIndex(콜백함수) : 콜백 함수 결과가 true인 첫 번째 요소의 '인덱스'를 반환 
*/
