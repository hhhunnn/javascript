...
/*
    ...
    - 생성자 안에서 this 키워드를 이용해서 클래스의 멤버변수를 선언하고 초기화 할 수 있음
...
const jungjong = new King('이방과', '정종', '1357-07-26', '1419-10-24');
...
console.log(sample1Instance); // 퍼블릭 필드만 출력됨
// console.log(sample1Instance.#privateField);
// console.log(sample1Instance.staticPublicField); // undefined

// 정적 퍼블릭 필드 가져오려면 클래스로 접근해야함
...
console.log(sample2Instance.privateField); // undefined -> get메서드 사용(프라이빗 필드 출력)
// console.log(sample2Instance.privateField()); // error

// set 메서드 사용
// sample2Instance.privateField('변경 프라이빗 필드'); // error
...
console.log(child2Instance.child2FieldField); // undefined
child2Instance.parentMethod(); // 오버라이딩 확인 -> O
